...
class DoadorDAO:
    ...
    def listar_doadores(self):
        ...
        for id_usuario, cpf, id_telefone in linhas:
            lista_doadores.append((id_usuario, cpf, id_telefone))
    ...
    def inserir_doador(self, doador: Doador):
        ...
        """
        parametros = (doador.get_id(), doador.get_cpf(), doador.get_id_telefone())
    ...
    def atualizar_doador(self, doador: Doador):
        ...
        """
        parametros = (doador.get_id_telefone(), doador.get_id())
        self.__banco_dados.executar(comando, parametros)
